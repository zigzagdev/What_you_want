    ...
    <div class="container">
        ...
        <form action="" method="POST" class="order">
            ...
            <fieldset>
                ...
                <input type="text" name="full-name" id="full-name" placeholder="Test Test" class="input-responsive" required>
                <div class="order-label text-white">Phone Number</div>
                <label for="contact"></label>
                <input type="tel" name="contact" id="contact" placeholder="090-1234-1234" class="input-responsive" required>
                <div class="order-label text-white">Email</div>
                <label for="email"></label>
                <input type="email" name="email" id="email" placeholder="1234aa@test.com" class="input-responsive" required>
